...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002372764752').split()] #Channel id for auto indexing ( make sure bot is admin )
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002986773524') #Channel / Group Id for force sub ( make sure bot is admin )
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://maheshbambhava365:maheshbambhava365@cluster0.vq28r.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
