...
PICS = (environ.get('PICS', 'https://envs.sh/bE0.jpg')).split() #SAMPLE PIC
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003001499416').split()] #Channel id for auto indexing ( make sure bot is admin )
...
auth_channel = environ.get('AUTH_CHANNEL', '-1003180553398') #Channel / Group Id for force sub ( make sure bot is admin )
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002263224485') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002208017487') # request channel id ( make sure bot is admin )
...
F_DB_URI = environ.get('F_DB_URI', "mongodb+srv://vanibo2187:vanibo2187@cluster0.ienqvps.mongodb.net/?retryWrites=true&w=majority")   # This Db Is For File Data Store
S_DB_URI = environ.get('S_DB_URI', "mongodb+srv://sahiva4263:sahiva4263@cluster0.ztydr8t.mongodb.net/?retryWrites=true&w=majority")   # This Db is for File Data Store When First Db Is Going To Be Full.
...
HOWTOVERIFY = environ.get('HOWTOVERIFY', 'https://t.me/c/2437541681/364') # How to open tutorial link for verification
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/akimax06')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/akimax_06')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/c/2437541681/364') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : akimax')
...
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', '-1002208017487'))
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', 'low-lenore-movie2025-3c67bc65.koyeb.app'))
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002084819782'))
